...
| POST | `/api/yandex` | Rate limit (10/мин) | YandexGPT ⚠️ требует ключ |
| POST | `/api/kandinsky` | Rate limit (10/мин) | Kandinsky ⚠️ требует ключ |
| POST | `/api/gigachat` | Rate limit (10/мин) | GigaChat ⚠️ требует ключ |
